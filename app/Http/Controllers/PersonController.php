...
class PersonController extends Controller
{
    ...
    {
        $regionSelects = \App\Region::all();

        ($request->get('regions')) ? $region = $request->get('regions') : $region = null;
        $persons = \App\Person::with('region')
                    ->where('id','LIKE',"%$region%")
                    ->paginate(5);
        return view('persons.index',['persons'=>$persons, 'regionSelects' =>$regionSelects]);
    }
    ...
    public function create()
    {
        ...
        return view('persons.create', compact('regions'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('persons.edit',['person'=>$person, 'regions'=>$regions]);
    }
